                        ...
                        <div class="card-body">
                            ...
                            <article class="card">
                                <div class="card-body row">
                                    <div class="col"> <strong>Perkiraan Waktu Pengiriman:</strong> <br><?php echo $deliveryTime; ?> menit</div>
                                    <div class="col"> <strong>Pengiriman Oleh:</strong> <br> <?php echo $deliveryBoyName; ?> | <i class="fa fa-phone"></i> <?php echo $deliveryBoyPhoneNo; ?> </div>
                                    <div class="col"> <strong>Status:</strong> <br> <?php echo $tstatus; ?> </div>
                                    <div class="col"> <strong>Pelacakan #:</strong> <br> <?php echo $trackId; ?> </div>
                                </div>
                            </article>
                            <div class="track">
                            <?php
                            ...
                            <a href="contact.php" class="btn btn-warning" data-abc="true">Bantuan <i class="fa fa-chevron-right"></i></a>
                        </div>
                    </article>
                </div>
            </div>
