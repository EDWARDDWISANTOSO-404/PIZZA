  ...
  <?php include 'partials/_nav.php';?>
                    ...
                    <div class="contact-box p-4">
                      ...
                      <form action="partials/_manageContactUs.php" method="POST">
                        <div class="row">
                          ...
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                                <b><label for="phone">No Telpon:</label></b>
                          ...
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                              ...
                              <small id="orderIdHelp" class="form-text text-muted">Jika masalah Anda tidak terkait dengan pesanan (ID pesanan = 0).</small>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                          ...
                          <?php }else { ?>
                            <div class="col-lg-12">
                              ...
                              <small class="form-text text-muted">Pertama masuk ke Kontak Kami.</small>
                            </div>
                          <?php } ?>
                        </div>
                      </form>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(187 188 189);">
              <h5 class="modal-title" id="adminReply">Balasan Admin</h5>
      ...
      <div class="modal fade" id="history" tabindex="-1" role="dialog" aria-labelledby="history" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(187 188 189);">
              <h5 class="modal-title" id="history">Pesan Anda Terkirim</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
