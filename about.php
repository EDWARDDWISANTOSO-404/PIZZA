      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Selamat Datang<span>Pizza Rasa Kadal</span></h2>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Memulai</a>
              </div>
            </div>
          </div>
          <!-- Slide 2 -->
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">Pizza Hots</h2><p>CE084 <a href="https://github.com/darshankparmar" target="_blank">@darshankparmar</a></p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Memulai</a>
              </div>
            </div>
          </div>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3>Selamat Datang Di <strong>Pizza Hots</strong></h3>
            <h3><strong>Pemimpin Pengiriman Pizza di Seluruh Subang</strong></h3>
            <p class="font-italic">
          </div>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <p><strong>Customers Senang</strong></p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <span data-toggle="counter-up">9,463</span>
              <p><strong>Dukungan Kami</strong></p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <p><strong>Pekerja Keras</strong></p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              ...
              <div class="member-info">
                ...
                <div class="social">
                  <a href="https://twitter.com/Edward" target="_blank"><i class="icofont-twitter"></i></a>
